				...
				<button>
					<span className="icon">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 61" fill="none">
							<path d="M13.2004 59.1459L9.39272 54.6459C8.84279 53.996 9.30475 53 10.1561 53H34.5914C35.3981 53 35.8728 53.906 35.4136 54.5692L32.2982 59.0692C32.1115 59.339 31.8042 59.5 31.476 59.5H13.9638C13.6696 59.5 13.3904 59.3705 13.2004 59.1459Z" stroke="white" stroke-width="2"/>
							<rect x="1" y="1" width="43" height="52" rx="4" stroke="white" stroke-width="2"/>
							<rect x="10" y="9" width="25" height="36" rx="1" stroke="white" stroke-width="2"/>
							<path d="M10 24C10 24 18.2424 15 21.6364 15C23.0909 15 26 16.5 26 19C26 22 14.9998 33 10.5 38C9.27408 39.3622 11.9452 41.9804 12.4271 42.4326C12.476 42.4785 12.5264 42.5156 12.5846 42.5488C13.2073 42.9041 17.0807 45.0504 17.9998 44C21.4996 40 34.9998 24 34.9998 24" stroke="white" stroke-width="2"/>
						</svg>
					</span>
				...
				<button onClick={handleBackButton}>
					<span className="icon">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 53 35" fill="none">
							<path d="M2 10.9991C2 10.9991 35 10.998 42 10.9991C46 10.9998 52 16.5477 52 22.4991C52 29 47.5 33.4992 44 33.4992C38 33.4992 27.5 33.4992 27.5 33.4992M2 10.9991L11 1M2 10.9991L11.5 20" stroke="white" stroke-width="2"/>
						</svg>
					</span>
				...
				<div className="block_header">
					...
					<span className="icon_right">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 67 69" fill="none">
							<path d="M21.2832 16.3606L9.25961 8.63118C8.81707 8.34669 8.29183 8.85077 8.55789 9.30463L15.9055 21.8387C15.9664 21.9427 15.9878 22.0653 15.9655 22.1837L14.5536 29.7142C14.5205 29.8909 14.3951 30.0362 14.2251 30.0948L1.71643 34.4081C1.23629 34.5737 1.28024 35.2667 1.77745 35.3703L11.7068 37.4389C11.8873 37.4765 12.0325 37.6104 12.0845 37.7873L14.4385 45.791C14.4777 45.9243 14.4597 46.0679 14.3888 46.1873L6.1448 60.0719C5.87197 60.5314 6.41329 61.041 6.85548 60.7409L18.7827 52.6474C18.9188 52.5551 19.0915 52.5356 19.2447 52.5952L27.7671 55.9094C27.9137 55.9664 28.025 56.0891 28.0674 56.2406L31.0781 66.9932C31.2094 67.462 31.8651 67.4858 32.03 67.0277L35.9229 56.2141C35.9719 56.0781 36.0774 55.9699 36.2121 55.9175L44.7448 52.5992C44.9038 52.5374 45.0833 52.5609 45.2211 52.6615L56.1086 60.6178C56.5441 60.9361 57.1054 60.4344 56.8378 59.9661L50.129 48.2257C50.0481 48.0842 50.0413 47.9122 50.1107 47.7648L53.9118 39.6874C53.9683 39.5674 54.0701 39.4748 54.1949 39.4298L65.0277 35.53C65.4858 35.3651 65.462 34.7094 64.9932 34.5781L54.2798 31.5783C54.1068 31.5299 53.9731 31.3924 53.9295 31.2181L52.0542 23.717C52.0197 23.5789 52.0457 23.4327 52.1256 23.3149L60.4251 11.0841C60.7142 10.658 60.2483 10.1259 59.7877 10.3561L47.717 16.3915C47.58 16.46 47.4191 16.4619 47.2805 16.3967L39.197 12.5927C39.0714 12.5336 38.976 12.4249 38.9337 12.2927L35.5081 1.58796C35.357 1.11548 34.6842 1.12783 34.5505 1.60553L31.5666 12.2623C31.5246 12.4121 31.4153 12.5339 31.2708 12.5917L21.7393 16.4043C21.5891 16.4643 21.4192 16.4481 21.2832 16.3606Z" stroke="white" stroke-width="2"/>
